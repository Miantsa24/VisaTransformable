...
INSERT INTO document (libelle, obligatoire, type_cible) VALUES
  ...
  ('Notice de renseignement', TRUE, 'commun'),
  ('Demande adressée à Monsieur le Ministre de l''Intérieur et de la Décentralisation (avec adresse e-mail et numéro de téléphone portable)', TRUE, 'commun'),
  ('Photocopie certifiée du visa en cours de validité', TRUE, 'commun'),
  ('Photocopie certifiée de la première page du passeport', TRUE, 'commun'),
...
INSERT INTO document (libelle, obligatoire, type_cible) VALUES
  ...
  ('Extrait d''inscription au registre du commerce', TRUE, 'investisseur'),
...
INSERT INTO document (libelle, obligatoire, type_cible) VALUES
  ...
  ('Attestation d''emploi délivrée par l''employeur', TRUE, 'travailleur');